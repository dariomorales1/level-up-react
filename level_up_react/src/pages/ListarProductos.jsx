...
const ProductList = ({ products: initialProducts, onEdit, onDelete }) => {
  ...
  const handleDelete = (codigo) => {
    if (window.confirm('¿Estás seguro de que quieres eliminar este producto?')) {
      if (typeof onDelete === 'function') onDelete(codigo);
      const updatedProducts = products.filter(product => product.Código !== codigo);
      ...
      <div className="products-grid">
        {filteredProducts.map(product => {
          ...
          const handleImgError = (e) => {
            ...
            e.currentTarget.src = 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="400" height="300"><rect width="100%" height="100%" fill="%23f3f3f3"/><text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" fill="%23666" font-family="Arial, Helvetica, sans-serif" font-size="18">Imagen no disponible</text></svg>';
          };

          return (
          <div key={product.Código} className="product-card">
            <div className="product-image">
              <img src={imgSrc || ''} alt={product.Nombre} onError={handleImgError} />
            </div>
            ...
            <div className="product-info">
              ...
              <p className="product-rating">Puntuación: {product.Puntuacion}/10</p>
